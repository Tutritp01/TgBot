...
class CarRepositoryTest {
    ...
    void saveCar() {
        ...
        carRepository.save(new Car("id4", "brand4", "model4", "4g", "mod4", "engine4", 2004));
        carRepository.save(new Car("id5", "brand5", "model5", "5g", "mod5", "engine5", 2005));

        assertEquals(expected, carRepository.count());

        int expected2 = carRepository.count();
        carRepository.save(new Car("id3", "brand4", "model5", "6g", "mod7", "engine8", 2009));
        assertEquals(expected2, carRepository.count());
    }

    @Test
    void saveAll() {
        Car car29 = new Car("id29", "brand29", "model29", "29g", "mod29", "engine29", 2029);
        Car car30 = new Car("id30", "brand30", "model30", "30g", "mod30", "engine30", 2030);
        Car car31 = new Car("id31", "brand31", "model31", "31g", "mod31", "engine31", 2031);
    ...
    void findByIdCar() {
        ...
        Car car12 = new Car("id11", "brand12", "model12", "12g", "mod12", "engine12", 2012);
    ...
    @Test
    void findAll() {
        assertEquals(CarRepository.cars, carRepository.findAll());
    }
    ...
    void count() {
        ...
        carRepository.save(car23);
        carRepository.save(car24);
        carRepository.save(car25);
        int size = CarRepository.cars.size();
        carRepository.delete(car23);
        carRepository.delete(car24);
